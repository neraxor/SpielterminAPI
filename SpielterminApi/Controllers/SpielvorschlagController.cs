...
namespace SpielterminApi.Controllers
{
    ...
    public class SpielvorschlagController : ControllerBase
    {
        ...
        {
            var spielvorschlagExists = _context.Spielvorschlags.Any(s => s.TerminId == request.TerminId && s.Spielvorschlag1 == request.Spielvorschlag1);
            ...
            _context.Spielvorschlags.Add(spielvorschlag);
